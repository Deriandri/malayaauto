...
Exp2=$(curl -sS https://raw.githubusercontent.com/Deriandri/ip/main/izin | grep $MYIP | awk '{print $3}')
export RED='\033[0;31m'
...
cd
rm -rf *
wget https://raw.githubusercontent.com/Deriandri/malayaauto/main//m-update.sh
clear
